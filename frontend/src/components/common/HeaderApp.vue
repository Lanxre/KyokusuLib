      ...
      <div class="flex items-center gap-3 md:gap-4">
        ...
        <div class="relative" ref="userDropdownRef">
            ...
            <button 
                v-else 
                @click="goToLogin"
                class="hidden md:flex justify-center gap-2 items-center bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 transition-colors px-6 py-3 rounded-2xl cursor-pointer"
            >
    ...
    <Transition name="slide-fade">
      ...
      >
        <nav class="flex flex-col p-4 gap-2 pb-10">
          ...
          <RouterLink to="/catalog" class="w-full text-center py-3 text-lg font-medium hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-white rounded-xl transition-colors" @click="closeMobileMenu">Каталог</RouterLink>
          <RouterLink to="/top" class="w-full text-center py-3 text-lg font-medium hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-white rounded-xl transition-colors" @click="closeMobileMenu">Топы</RouterLink>
          <RouterLink to="/forum" class="w-full text-center py-3 text-lg font-medium hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-white rounded-xl transition-colors" @click="closeMobileMenu">Форум</RouterLink>
          
          <div class="w-full border-t border-zinc-200 dark:border-zinc-700 my-2 opacity-50"></div>
          
          <RouterLink to="/search" class="flex items-center gap-3 px-6 py-3 rounded-xl bg-zinc-100 dark:bg-zinc-800/50 hover:bg-zinc-200 dark:hover:bg-zinc-800 w-full justify-center transition-colors text-zinc-700 dark:text-zinc-200" @click="closeMobileMenu">
            <img :src="SearchIcon" class="h-5 w-5 dark:invert" />
            <span>Поиск</span>
          </RouterLink>
          
          <RouterLink to="/bookmarks" class="flex items-center gap-3 px-6 py-3 rounded-xl bg-zinc-100 dark:bg-zinc-800/50 hover:bg-zinc-200 dark:hover:bg-zinc-800 w-full justify-center transition-colors text-zinc-700 dark:text-zinc-200" @click="closeMobileMenu">
