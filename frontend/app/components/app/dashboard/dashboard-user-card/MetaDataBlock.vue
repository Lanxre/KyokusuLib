...
<template>
    <div class="grid grid-cols-2 gap-3">
		<div class="flex flex-col items-start bg-zinc-50 dark:bg-zinc-800/50 rounded-xl px-4 py-3 border border-zinc-700">
			...
			<span class="inline-flex items-center gap-1.5 text-sm font-semibold text-zinc-700 dark:text-zinc-300">
				<span
		...
		<div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl px-4 py-3 border border-zinc-700">
			...
			<p class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">#{{ user.id }}</p>
		</div>
		<div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl px-4 py-3 border border-zinc-700">
			<div class="flex gap-2">
			...
			<p class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">{{ fmtDate(user.create_at) }}</p>
		</div>
		<div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl px-4 py-3 border border-zinc-700">
			<div class="flex gap-2">
                <p class="text-[10px] font-semibold uppercase tracking-widest text-zinc-400 mb-1">Последний вход</p>
